...
var NbMenuComponent = /** @class */ (function () {
    ...
    NbMenuComponent.prototype.onItemClick = function (item) {
        ...
        if(item.title == "Home"){
            ...
            {title: "New Market", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
            {title: "Mt Eden", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
            {title: "Epsom", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
            {title: "CBD", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"}            
            ]
        }
        else if(item.title == "New Market"){
            this.items = 
            [
                {title: "New Market", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full", selected:true},
                {title: "Mt Eden", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "Epsom", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "CBD", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"}   
            ]
        }
        else if(item.title == "Mt Eden"){
            this.items = 
            [
                {title: "New Market", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "Mt Eden", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full" , selected:true},
                {title: "Epsom", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "CBD", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"}   
            ]
        }
        else if(item.title == "Epsom"){
            this.items = 
            [
                {title: "New Market", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "Mt Eden", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "Epsom", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full" , selected:true},
                {title: "CBD", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"}   
            ]
        }
        else if(item.title == "CBD"){
            this.items = 
            [
                {title: "New Market", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "Mt Eden", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "Epsom", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full"},
                {title: "CBD", icon: "nb-audio", subMenuHeight: 0, pathMatch: "full" , selected:true}   
            ]
        }
