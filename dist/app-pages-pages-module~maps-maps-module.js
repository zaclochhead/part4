    ...
    <nb-card>
      ...
      <nb-card-body>
        <agm-map [zoom] = "15" [latitude]="lat" [longitude]="lng">
          ...
          <agm-circle (circleClick) = "changeFill()" [latitude]="lat" [longitude]="lng" [radius] = "100" [fillColor]=fill></agm-circle>
        </agm-map>
      </nb-card-body>
    </nb-card>
  `,
...
export class GmapsComponent {
  // api key AIzaSyA8GehGlxBgBbccqc8A4ke5eIApQ-SQlTo
  dB;
  lat = -36.8664060;
  lng = 174.7727780;
  ...
  changeFill(totalSound){
    if(totalSound<300){
      this.red = (totalSound/30)*2.5
      this.fill = "rgb("+this.red+","+this.green+","+this.blue+")";
    }
    else{
        this.red =255;
        this.green = 255 - totalSound/50;
        if(this.green>0){
          this.fill = "rgb("+this.red+","+this.green+","+this.blue+")";
        }
        else{
          this.fill = "rgb("+this.red+","+255+","+this.blue+")";
        }
    }
  }
...
var GmapsComponent = /** @class */ (function () {
    ...
    GmapsComponent.prototype.setMapType = function (mapTypeId) {
